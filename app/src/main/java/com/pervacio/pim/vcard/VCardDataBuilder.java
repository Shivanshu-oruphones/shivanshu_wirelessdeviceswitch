 ...
 */
package com.pervacio.pim.vcard;

import android.accounts.Account;
import android.util.Log;

import com.pervacio.pim.vcard.codec.DecoderException;
import com.pervacio.pim.vcard.codec.binary.Base64;
import com.pervacio.pim.vcard.codec.net.QuotedPrintableCodec;
...
//            Log.e(LOG_TAG, "VCard parser - contact struct already exists - assume the vcard builder is being reused for a different vCard");
        }
    ...
    private String handleOneValue(String value, String targetCharset, String encoding) {
        if (encoding != null) {
            if (encoding.equalsIgnoreCase("BASE64") || encoding.equalsIgnoreCase("B")) {
            	// Media Mushroom: encoding equality test changed to case insensitive because we sometimes see lower case versions
